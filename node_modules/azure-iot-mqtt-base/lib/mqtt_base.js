...
var OnTheWirePublish = /** @class */ (function () {
    function OnTheWirePublish(enqueuedTimeSecondsSinceEpoch, publishCallback, identifier) {
        this.enqueuedTimeSecondsSinceEpoch = enqueuedTimeSecondsSinceEpoch;
        this.publishCallback = publishCallback;
        this.identifier = identifier;
    }
    return OnTheWirePublish;
}());
...
var MqttBase = /** @class */ (function (_super) {
            ...
            states: {
                disconnected: {
                    _onEnter: function (callback, err) {
                        ...
                        //
                        _this._purgePublishesOnTheWire(err);
                        //
                ...
                connected: {
                    ...
                    publish: function (topic, payload, options, callback) {
                        var thisPublishIdentifier = uuid.v4();
                        _this._publishesOnTheWire[thisPublishIdentifier] = new OnTheWirePublish(Math.floor(Date.now() / 1000), callback, thisPublishIdentifier);
                        ...
                        _this._mqttClient.publish(topic, payload, options, function (err, result) {
                            ...
                            //
                            var current = _this._publishesOnTheWire[thisPublishIdentifier];
                            if (current) {
                                delete _this._publishesOnTheWire[thisPublishIdentifier];
    ...
    MqttBase.prototype._purgePublishesOnTheWire = function (err) {
        var errorForPurgedPublish = err || new azure_iot_common_1.errors.NotConnectedError('Connect was lost');
        var existingPublishes = this._publishesOnTheWire;
        this._publishesOnTheWire = {};
        Object.keys(existingPublishes).forEach(function (messageIdentifier) {
