...
var Mqtt = /** @class */ (function (_super) {
        ...
        _this._fsm = new machina.Fsm({
            ...
            states: {
                                    ...
                                    _this._mqtt.connect(baseConfig, function (err, result) {
                                        ...
                                        if (err) {
                                            if (_this._firstConnection) {
                                                ...
                                                _this._fsm.transition('disconnected', connectCallback, new Error('Failure on first connection (Not authorized): ' + err.message));
                                            }
                                            else {
                ...
                connected: {
                    ...
                    enableC2D: function (callback) {
                        if (_this._topics.message && _this._topics.message.subscribed) {
                    ...
                    enableMethods: function (callback) {
                        if (_this._topics.method && _this._topics.method.subscribed) {
                    ...
                    enableInputMessages: function (callback) {
                        if (_this._topics.inputMessage && _this._topics.inputMessage.subscribed) {
    ...
    Mqtt.prototype._getBaseTransportConfig = function (credentials) {
        ...
        var apiVersionString = this._mid ? azure_iot_common_1.endpoint.versionQueryStringPnP() : azure_iot_common_1.endpoint.versionQueryString();
